...
require.register("js/demo.js", function(exports, require, module) {
'use strict';
...
function initCards() {
  return ['A', 'H', 'D', 'E', 'B', 'C', 'F', 'G', 'F', 'B', 'G', 'D', 'C', 'E', 'H', 'A'];
}
...
var Demo = function (_React$Component) {
  ...
  _createClass(Demo, [{
    key: 'handleClick',
    value: function handleClick(i, isGuess) {
      var _this2 = this;

      var memory = this.state.memory.slice();
      if (memory[i] != null || this.state.isLock) {
        return;
      }
      ...
      if (!isGuess) {
        ...
        if (memory[i] === memory[lastCard]) {
          var completeNum = this.state.completeNum + 2;
    ...
    value: function renderCard(i) {
      ...
      return _react2.default.createElement(Card, {
        ...
        onClick: function onClick() {
          return _this3.handleClick(i, _this3.state.isGuess);
        }
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var score = "Your Score: " + (100 - this.state.numClicks);
      var completeNum = this.state.completeNum;
      var win = '';
      if (completeNum === 16) {
        win = "You Win !!!";
      }
